...
CREATE TABLE `ad` (
  ...
  `show_in` varchar(32) DEFAULT NULL COMMENT '展示平台',
  `show_at` varchar(32) DEFAULT NULL COMMENT '展示位置',
  `show_time_start` varchar(32) DEFAULT NULL COMMENT '开始时间',
  `show_time_end` varchar(32) DEFAULT NULL COMMENT '结束时间',
...
-- Records of ad
-- ----------------------------
INSERT INTO `ad` VALUES ('31366e1b8cd9604649ae71c4c9d2ab68', 'jeecg', '2019-09-07 16:14:13', null, null, null, 'mj', '1', '2019-09-02 16:13:54', '2019-09-29 16:13:56', '1', 'files/20190907/2010_1567844046933.png', '2');
INSERT INTO `ad` VALUES ('75434ce0b375165def6a772696e5549f', 'jeecg', '2019-09-07 16:13:16', null, null, null, 'mj', '1', '2019-09-01 16:12:59', '2019-09-30 16:13:01', '1', 'files/20190907/2010_1567843992089.png', '1');
...
-- ----------------------------
-- Table structure for `mj_account`
-- ----------------------------
DROP TABLE IF EXISTS `mj_account`;
CREATE TABLE `mj_account` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新日期',
  `sys_org_code` varchar(64) DEFAULT NULL COMMENT '所属部门',
  `account_type` varchar(32) DEFAULT NULL COMMENT '平台名称',
  `account_num` varchar(32) DEFAULT NULL COMMENT '帐号',
  `status` varchar(32) DEFAULT NULL COMMENT '帐号状态',
  `owner_name` varchar(32) DEFAULT NULL COMMENT '所有人名称',
  `owner_mobile` varchar(32) DEFAULT NULL COMMENT '所有人电话',
  `qr_code_image` varchar(32) DEFAULT NULL COMMENT '收款二维码',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of mj_account
-- ----------------------------
INSERT INTO `mj_account` VALUES ('6251379e3fbbdd5d60ea9f4eb92935ae', 'admin', '2019-09-08 22:46:51', null, null, 'A01', 'wx', '1324', '5', '大蚰', '13132', null);

-- ----------------------------
-- Table structure for `mj_can_return`
-- ----------------------------
DROP TABLE IF EXISTS `mj_can_return`;
CREATE TABLE `mj_can_return` (
  `id` varchar(36) NOT NULL,
  `create_by` varchar(50) DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建日期',
  `update_by` varchar(50) DEFAULT NULL COMMENT '更新人',
  `update_time` datetime DEFAULT NULL COMMENT '更新日期',
  `sys_org_code` varchar(64) DEFAULT NULL COMMENT '所属部门',
  `pay_record_id` varchar(32) DEFAULT NULL COMMENT '支付记录',
  `user_id` varchar(32) DEFAULT NULL COMMENT '玩家ID',
  `return_num` varchar(32) DEFAULT NULL COMMENT '可返金额',
  `status` varchar(32) DEFAULT NULL COMMENT '可返状态',
  `follower_direct_id` varchar(32) DEFAULT NULL COMMENT '一级下线ID',
  `follower_direct` varchar(32) DEFAULT NULL COMMENT '一级下线',
  `follower_indirect_id` varchar(32) DEFAULT NULL COMMENT '二级下线ID',
  `follower_indirect` varchar(32) DEFAULT NULL COMMENT '二级下线',
  `return_id` varchar(32) DEFAULT NULL COMMENT '返现ID',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of mj_can_return
-- ----------------------------

-- ----------------------------
-- Table structure for `mj_card`
-- ----------------------------
DROP TABLE IF EXISTS `mj_card`;
CREATE TABLE `mj_card` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新日期',
  `sys_org_code` varchar(64) DEFAULT NULL COMMENT '所属部门',
  `name` varchar(32) DEFAULT NULL COMMENT '收款人名称',
  `bank_type` varchar(32) DEFAULT NULL COMMENT '银行',
  `card_num` varchar(32) DEFAULT NULL COMMENT '银行卡号码',
  `status` varchar(32) DEFAULT NULL COMMENT '帐号状态',
  `qr_code_image` varchar(32) DEFAULT NULL COMMENT '收款二维码',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- Records of mj_card
-- ----------------------------
INSERT INTO `mj_card` VALUES ('b9d1542f06faaa76e0bf52e62088390d', 'admin', '2019-09-08 22:49:48', null, null, 'A01', '大', '2', '353535', '5', null);

-- ----------------------------
-- Table structure for `mj_cash_back_can`
-- ----------------------------
DROP TABLE IF EXISTS `mj_cash_back_can`;
CREATE TABLE `mj_cash_back_can` (
  `id` varchar(36) NOT NULL,
  `create_by` varchar(50) DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建日期',
  `update_by` varchar(50) DEFAULT NULL COMMENT '更新人',
  ...
  `sys_org_code` varchar(64) DEFAULT NULL COMMENT '所属部门',
  `pay_record_id` varchar(32) DEFAULT NULL COMMENT '支付记录',
  `player_id` varchar(32) DEFAULT NULL COMMENT '玩家ID',
  `cash_back_num` varchar(32) DEFAULT NULL COMMENT '可返金额',
  `status` varchar(32) DEFAULT NULL COMMENT '可返状态',
  `follower_direct_id` varchar(32) DEFAULT NULL COMMENT '一级下线ID',
  `follower_direct` varchar(32) DEFAULT NULL COMMENT '一级下线',
  `follower_indirect_id` varchar(32) DEFAULT NULL COMMENT '二级下线ID',
  `follower_indirect` varchar(32) DEFAULT NULL COMMENT '二级下线',
  `cash_back_id` varchar(32) DEFAULT NULL COMMENT '返现ID',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of mj_cash_back_can
-- ----------------------------

-- ----------------------------
-- Table structure for `mj_cash_back_record`
-- ----------------------------
DROP TABLE IF EXISTS `mj_cash_back_record`;
CREATE TABLE `mj_cash_back_record` (
  `id` varchar(36) NOT NULL,
  `create_by` varchar(50) DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建日期',
  `update_by` varchar(50) DEFAULT NULL COMMENT '更新人',
  `update_time` datetime DEFAULT NULL COMMENT '更新日期',
  `sys_org_code` varchar(64) DEFAULT NULL COMMENT '所属部门',
  `player_id` varchar(32) DEFAULT NULL COMMENT '申请用户',
  `total_num` varchar(32) DEFAULT NULL COMMENT '申请金额',
  `status` varchar(32) DEFAULT NULL COMMENT '返现状态',
  `done_num` varchar(32) DEFAULT NULL COMMENT '执行金额',
  `done_time` varchar(32) DEFAULT NULL COMMENT '执行时间',
  `pay_record_id` varchar(32) DEFAULT NULL COMMENT '支付记录',
  `picture_path` varchar(32) DEFAULT NULL COMMENT '回执图片',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of mj_cash_back_record
-- ----------------------------
...
CREATE TABLE `mj_conf` (
  ...
  `content` varchar(32) DEFAULT NULL COMMENT '设置内容',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- Records of mj_conf
-- ----------------------------
INSERT INTO `mj_conf` VALUES ('f84f7f06307a38f29053707ecb1dab43', 'jeecg', '2019-09-08 22:38:08', null, null, null, 'f548255f084717703dcbdb78d3f170c9', '5d5e27c2524debe823647c5d4bd41d2f', '{\"a\":\"231\"}');

-- ----------------------------
-- Table structure for `mj_game`
-- ----------------------------
...
CREATE TABLE `mj_game` (
  ...
  `icon` varchar(64) DEFAULT NULL COMMENT '平台图标',
  `status` varchar(32) DEFAULT NULL COMMENT '平台状态',
  `sort` int(11) DEFAULT NULL COMMENT '排列顺序',
  `star` int(11) DEFAULT NULL COMMENT '选择次数',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- Records of mj_game
-- ----------------------------
INSERT INTO `mj_game` VALUES ('27bd920e509cdaf3a58a5f9cd6cd1263', 'admin', '2019-09-07 17:22:00', null, null, 'A01', '皮皮麻将', 'files/20190907/2010_1567848117413.png', '1', '1', '1');
INSERT INTO `mj_game` VALUES ('5d5e27c2524debe823647c5d4bd41d2f', 'admin', '2019-09-07 17:27:49', null, null, 'A01', '熊猫麻将', 'files/20190907/2010_1567848460065.png', '1', '2', '1');

-- ----------------------------
-- Table structure for `mj_notice`
-- ----------------------------
DROP TABLE IF EXISTS `mj_notice`;
CREATE TABLE `mj_notice` (
  `id` varchar(36) NOT NULL,
  `create_by` varchar(50) DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建日期',
  `update_by` varchar(50) DEFAULT NULL COMMENT '更新人',
...
-- ----------------------------
-- Records of mj_notice
-- ----------------------------

-- ----------------------------
-- Table structure for `mj_pay_picture`
-- ----------------------------
DROP TABLE IF EXISTS `mj_pay_picture`;
CREATE TABLE `mj_pay_picture` (
  `id` varchar(36) NOT NULL,
  `create_by` varchar(50) DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建日期',
  `update_by` varchar(50) DEFAULT NULL COMMENT '更新人',
  ...
  `player_id` varchar(32) DEFAULT NULL COMMENT '用户ID',
  `status` varchar(32) DEFAULT NULL COMMENT '状态',
  `action` varchar(64) DEFAULT NULL COMMENT '支付动作',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of mj_pay_picture
-- ----------------------------
INSERT INTO `mj_pay_picture` VALUES ('dad7d28d050bbe78c8a0ca7b59658884', 'jeecg', '2019-09-12 11:27:57', null, null, null, 'files\\20190912\\660ab97a-dc26-4563-96f5-c9e5c3d5e0fe.jpeg', 'f548255f084717703dcbdb78d3f170c9', '1', '1');

-- ----------------------------
-- Table structure for `mj_pay_record`
-- ----------------------------
DROP TABLE IF EXISTS `mj_pay_record`;
CREATE TABLE `mj_pay_record` (
  `id` varchar(36) NOT NULL,
  `create_by` varchar(50) DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建日期',
  `update_by` varchar(50) DEFAULT NULL COMMENT '更新人',
  `update_time` datetime DEFAULT NULL COMMENT '更新日期',
  `sys_org_code` varchar(64) DEFAULT NULL COMMENT '所属部门',
  `pay_type` varchar(32) DEFAULT NULL COMMENT '收入支出',
  `from_player_id` varchar(32) DEFAULT NULL COMMENT '支付用户',
  `from_account_type` varchar(32) DEFAULT NULL COMMENT '支付平台',
  `from_account` varchar(32) DEFAULT NULL COMMENT '支付帐号',
  `from_bank_type` varchar(32) DEFAULT NULL COMMENT '支付银行',
  `from_bank_account` varchar(32) DEFAULT NULL COMMENT '支付卡号',
  `to_player_id` varchar(32) DEFAULT NULL COMMENT '接收用户',
  `to_account_type` varchar(32) DEFAULT NULL COMMENT '接收平台',
  `to_account` varchar(32) DEFAULT NULL COMMENT '接收帐户',
  `to_bank_type` varchar(32) DEFAULT NULL COMMENT '接收银行',
  `to_bank_account` varchar(32) DEFAULT NULL COMMENT '接收卡号',
  `pay_order_id` varchar(32) DEFAULT NULL COMMENT '支付订单号',
  `pay_num` varchar(32) DEFAULT NULL COMMENT '支付金额',
  `pay_time` varchar(32) DEFAULT NULL COMMENT '支付时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of mj_pay_record
-- ----------------------------

-- ----------------------------
-- Table structure for `mj_plateform`
-- ----------------------------
DROP TABLE IF EXISTS `mj_plateform`;
CREATE TABLE `mj_plateform` (
  `id` varchar(36) NOT NULL,
  `create_by` varchar(50) DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建日期',
  `update_by` varchar(50) DEFAULT NULL COMMENT '更新人',
...
-- ----------------------------
-- Records of mj_plateform
-- ----------------------------

-- ----------------------------
-- Table structure for `mj_player`
-- ----------------------------
DROP TABLE IF EXISTS `mj_player`;
CREATE TABLE `mj_player` (
  `id` varchar(36) NOT NULL,
  `create_by` varchar(50) DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建日期',
  `update_by` varchar(50) DEFAULT NULL COMMENT '更新人',
  ...
  `promo_code` varchar(10) DEFAULT NULL COMMENT '推广码',
  `lever` varchar(32) DEFAULT NULL COMMENT '会员级别',
  `superior` varchar(32) DEFAULT NULL COMMENT '上级',
  `notice_way` varchar(32) DEFAULT NULL COMMENT '通知方式',
  `can_cashback_time` varchar(32) DEFAULT NULL COMMENT '可返次数',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of mj_player
-- ----------------------------
INSERT INTO `mj_player` VALUES ('30d306e11f1e970c698729418ce781f2', 'jeecg', '2019-09-08 13:15:18', null, null, null, null, '2', '18328509888', '1', null, null, 'f548255f084717703dcbdb78d3f170c9', null, null);
INSERT INTO `mj_player` VALUES ('8bf8261b4c78843c46f9ad7514772eec', 'jeecg', '2019-09-09 10:21:38', null, null, null, null, '2', '18328509890', '1', null, null, 'f548255f084717703dcbdb78d3f170c9', null, null);
INSERT INTO `mj_player` VALUES ('b10f90c60905d095477e2b77703ab137', 'jeecg', '2019-09-08 13:58:26', null, null, null, null, '2', '18328509889', '1', null, null, 'f548255f084717703dcbdb78d3f170c9', null, null);
INSERT INTO `mj_player` VALUES ('f548255f084717703dcbdb78d3f170c9', 'jeecg', '2019-09-08 12:49:14', null, null, null, null, '2', '18328509887', '1', '9527', null, '-1', null, null);

-- ----------------------------
-- Table structure for `mj_player_account`
-- ----------------------------
DROP TABLE IF EXISTS `mj_player_account`;
CREATE TABLE `mj_player_account` (
  `id` varchar(36) NOT NULL,
  `create_by` varchar(50) DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建日期',
  `update_by` varchar(50) DEFAULT NULL COMMENT '更新人',
  ...
  `sys_org_code` varchar(64) DEFAULT NULL COMMENT '所属部门',
  `player_id` varchar(32) DEFAULT NULL COMMENT '玩家ID',
  `account_type` varchar(32) DEFAULT NULL COMMENT '帐户类型',
  `account_num` varchar(32) DEFAULT NULL COMMENT '帐号',
  `status` varchar(32) DEFAULT NULL COMMENT '状态',
  `qr_code_image` varchar(32) DEFAULT NULL COMMENT '收款二维码',
  PRIMARY KEY (`id`)
...
-- ----------------------------
-- Records of mj_player_account
-- ----------------------------
INSERT INTO `mj_player_account` VALUES ('097379fa7e9718db769dc73282969dc9', 'jeecg', '2019-09-08 20:47:15', null, null, null, 'f548255f084717703dcbdb78d3f170c9', 'zfb', '1323232', '1', '/files/123123.jpg');
INSERT INTO `mj_player_account` VALUES ('c0cfa81a1330ba2157d66ed8092a627f', 'jeecg', '2019-09-08 20:45:17', null, null, null, 'f548255f084717703dcbdb78d3f170c9', 'wx', '1323232', '1', '/files/123123.jpg');

-- ----------------------------
-- Table structure for `mj_player_card`
-- ----------------------------
DROP TABLE IF EXISTS `mj_player_card`;
CREATE TABLE `mj_player_card` (
  `id` varchar(36) NOT NULL,
  `create_by` varchar(50) DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建日期',
  `update_by` varchar(50) DEFAULT NULL COMMENT '更新人',
...
-- ----------------------------
-- Records of mj_player_card
-- ----------------------------
INSERT INTO `mj_player_card` VALUES ('0560c244bea0ad871b93943e45ea8580', 'jeecg', '2019-09-08 20:37:17', null, null, null, 'f548255f084717703dcbdb78d3f170c9', '1', '13131313', '1', '/files/123123.jpg');

-- ----------------------------
-- Table structure for `mj_player_game`
-- ----------------------------
DROP TABLE IF EXISTS `mj_player_game`;
CREATE TABLE `mj_player_game` (
  `id` varchar(36) NOT NULL,
  `create_by` varchar(50) DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建日期',
  `update_by` varchar(50) DEFAULT NULL COMMENT '更新人',
  `update_time` datetime DEFAULT NULL COMMENT '更新日期',
  `sys_org_code` varchar(64) DEFAULT NULL COMMENT '所属部门',
  `player_id` varchar(36) DEFAULT NULL COMMENT '玩家ID',
  `game_id` varchar(36) DEFAULT NULL COMMENT '游戏ID',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of mj_player_game
-- ----------------------------
INSERT INTO `mj_player_game` VALUES ('63a2b0dec193bb0ebe81e6b6343c9046', 'jeecg', '2019-09-08 15:25:23', null, null, null, 'f548255f084717703dcbdb78d3f170c9', '5d5e27c2524debe823647c5d4bd41d2f');

-- ----------------------------
-- Table structure for `mj_return`
-- ----------------------------
DROP TABLE IF EXISTS `mj_return`;
CREATE TABLE `mj_return` (
  `id` varchar(36) NOT NULL,
  `create_by` varchar(50) DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建日期',
  `update_by` varchar(50) DEFAULT NULL COMMENT '更新人',
  `update_time` datetime DEFAULT NULL COMMENT '更新日期',
  `sys_org_code` varchar(64) DEFAULT NULL COMMENT '所属部门',
  `user_id` varchar(32) DEFAULT NULL COMMENT '申请用户',
  `total_num` varchar(32) DEFAULT NULL COMMENT '申请金额',
  `status` varchar(32) DEFAULT NULL COMMENT '返现状态',
  `retun_num` varchar(32) DEFAULT NULL COMMENT '执行金额',
  `return_time` varchar(32) DEFAULT NULL COMMENT '执行时间',
  `pay_record_id` varchar(32) DEFAULT NULL COMMENT '支付记录',
  `picture_path` varchar(32) DEFAULT NULL COMMENT '回执图片',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `mj_user` (
  ...
  `superior` varchar(32) DEFAULT NULL COMMENT '上级',
  `notice_way` varchar(32) DEFAULT NULL COMMENT '通知方式',
  `can_return_time` varchar(32) DEFAULT NULL COMMENT '可返次数',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- Records of mj_user
-- ----------------------------
INSERT INTO `mj_user` VALUES ('8a80cb816cf260d1016cfa17f33f0004', 'admin', '2019-09-04 10:26:09', null, null, 'A01', '大师兄', '1', '18328509887', '1', '9527', '4', null, '2', '100');

-- ----------------------------
-- Table structure for `mj_user_account`
-- ----------------------------
DROP TABLE IF EXISTS `mj_user_account`;
CREATE TABLE `mj_user_account` (
  `id` varchar(36) NOT NULL,
  `create_by` varchar(50) DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建日期',
  `update_by` varchar(50) DEFAULT NULL COMMENT '更新人',
...
-- ----------------------------
-- Records of mj_user_account
-- ----------------------------

-- ----------------------------
-- Table structure for `mj_user_card`
-- ----------------------------
DROP TABLE IF EXISTS `mj_user_card`;
CREATE TABLE `mj_user_card` (
  `id` varchar(36) NOT NULL,
  `create_by` varchar(50) DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建日期',
  `update_by` varchar(50) DEFAULT NULL COMMENT '更新人',
...
-- ----------------------------
-- Records of mj_user_card
-- ----------------------------

-- ----------------------------
-- Table structure for `mj_user_game`
-- ----------------------------
DROP TABLE IF EXISTS `mj_user_game`;
CREATE TABLE `mj_user_game` (
  `id` varchar(36) NOT NULL,
  `create_by` varchar(50) DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建日期',
  `update_by` varchar(50) DEFAULT NULL COMMENT '更新人',
...
-- ----------------------------
INSERT INTO `onl_cgform_button` VALUES ('0a2f2f612aeade8dcd60f3d68bcb9607', 'playerCardList', 'icon-edit', '银行卡', '1', 'link', null, '29edcae80449466fa0d29b913af7c7bd', 'js', '1');
...
INSERT INTO `onl_cgform_button` VALUES ('aa3707a187e8d7476f64195ca7f35c25', 'playerAccountList', 'icon-edit', '帐号', '1', 'link', null, '29edcae80449466fa0d29b913af7c7bd', 'js', '2');
...
INSERT INTO `onl_cgform_field` VALUES ('01eb6dcb6223fab0c55481155ab501b9', '5f1bd3c0d7bf4c009cfea6b7462405e7', 'id', '主键', null, '1', '0', 'string', '36', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '0', '0', 'single', '', '', '1', 'admin', '2019-09-04 09:09:31', '2019-09-03 11:32:51', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('01f0019bba9a152813ca0b6777149afc', '079eaa69a8ce44d2bd994c0269e82b4b', 'id', '主键', null, '1', '0', 'string', '36', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '0', '0', 'single', '', '', '1', 'admin', '2019-09-07 00:05:28', '2019-09-04 10:30:02', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('0250f9a62e99fe97f2a06bbce2c82d7e', 'e064ddb57a894ab79a8cb9db3aa82b8d', 'follower_indirect_id', '二级下线ID', null, '0', '1', 'String', '32', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '1', '0', 'single', '', '', '13', 'admin', '2019-09-08 17:39:52', '2019-09-04 09:37:14', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('031ef6fa7e8e7a39325a7daf029aad96', '079eaa69a8ce44d2bd994c0269e82b4b', 'status', '状态', null, '0', '1', 'String', '32', '0', '', 'notice_status', '', '', 'list', '', '120', null, '0', '', '', '1', '1', '1', 'single', '', '', '8', 'admin', '2019-09-07 00:05:28', '2019-09-04 10:30:02', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('0619c1119c1f2fafe719ddf757c40c03', '29edcae80449466fa0d29b913af7c7bd', 'name', '昵称', null, '0', '1', 'String', '32', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '1', '1', '1', 'single', '', '', '7', 'admin', '2019-09-07 10:05:10', '2019-09-02 20:43:43', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('0790d2dcbb7b37e32869fa4c5f49cc4f', 'f52b05a17fd3402fac2a0234cf82694a', 'qr_code_image', '收款二维码', null, '0', '1', 'String', '32', '0', '', '', '', '', 'image', '', '120', null, '0', '', '', '0', '1', '0', 'single', '', '', '11', 'admin', '2019-09-07 08:45:50', '2019-09-06 22:29:46', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('07c0403d209a881ccfd7afe59ae44a1b', 'c1d9eecac62744b79464ef59614cbc1b', 'card_num', '银行卡号码', null, '0', '1', 'String', '32', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '1', '1', '1', 'single', '', '', '9', 'admin', '2019-09-07 00:11:30', '2019-09-03 10:19:41', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('0ca04620c22ea25983ee6acd23a843bb', '5752e059cbcc4514ab0e9a6b3de6ec8b', 'sys_org_code', '所属部门', null, '0', '1', 'string', '64', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '0', '0', 'single', '', '', '6', 'admin', '2019-09-12 11:24:15', '2019-09-03 15:06:47', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('0df60932d29ff7d37abb9c52ae3ba04c', '4803dcecf97d43d7a418d1ecd007f749', 'update_time', '更新日期', null, '0', '1', 'Date', '20', '0', '', '', '', '', 'datetime', '', '120', null, '0', '', '', '0', '0', '0', 'single', '', '', '5', 'admin', '2019-09-07 16:07:29', '2019-09-04 10:53:56', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('101fc018123e26945fabdb4a4d61c2a1', 'c6582973284a45dab2c4994b0a7bb682', 'sys_org_code', '所属部门', null, '0', '1', 'string', '64', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '0', '0', 'single', '', '', '6', 'admin', '2019-09-07 08:45:41', '2019-09-02 23:52:40', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('121fad058b8544e829565d0e6e746205', '11d3a75729c943c28a2889ec260e9ea3', 'from_account', '支付帐号', null, '0', '1', 'String', '32', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '1', '1', '1', 'single', '', '', '10', 'admin', '2019-09-08 22:51:46', '2019-09-04 08:42:32', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('12b23926cdd55f6689ada8f54efcfdfe', 'b9d9b12dc4b941259a970f2eddea2660', 'create_by', '创建人', null, '0', '1', 'string', '50', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '0', '0', 'single', '', '', '2', 'admin', '2019-09-04 09:09:54', '2019-09-03 15:18:30', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('14563fc9f2c26bc9ef5cd7d7b40bfe5c', 'c1d9eecac62744b79464ef59614cbc1b', 'name', '收款人名称', null, '0', '1', 'String', '32', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '1', '1', '1', 'single', '', '', '7', 'admin', '2019-09-07 00:11:30', '2019-09-03 10:19:41', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('158133152450bdce66262e4c7803380a', '1a255b5c711a4b668bc080e1ef8827ac', 'sys_org_code', '所属部门', null, '0', '1', 'string', '64', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '0', '0', 'single', '', '', '6', 'admin', '2019-09-07 17:23:09', '2019-09-01 17:43:49', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('15b085200ffe66f961364b71787771d8', '5752e059cbcc4514ab0e9a6b3de6ec8b', 'action', '支付动作', null, '0', '1', 'String', '64', '0', '', 'pay_action', '', '', 'list', '', '120', null, '0', '', '', '1', '1', '1', 'single', '', '', '10', 'admin', '2019-09-12 11:24:15', '2019-09-12 08:28:24', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('175b3694920607cd8e5c5e7c107134e5', '7648448d3af048ed8a08349577c6155c', 'create_time', '创建日期', null, '0', '1', 'Date', '20', '0', '', '', '', '', 'datetime', '', '120', null, '0', '', '', '0', '0', '0', 'single', '', '', '3', 'admin', '2019-09-08 15:19:21', '2019-09-04 10:11:04', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('1771fced90cc1bfeecf1e94f32c2a2cd', '89898b29258546fd877f93b81227d5fe', 'id', '主键', null, '1', '0', 'string', '36', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '0', '0', 'single', '', '', '1', 'admin', '2019-09-08 18:34:10', '2019-09-04 09:51:09', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('1a2381e7dca0a382f9a56eaf7a84b46d', '5f1bd3c0d7bf4c009cfea6b7462405e7', 'pay_time', '支付时间', null, '0', '1', 'String', '32', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '1', '1', 'single', '', '', '15', 'admin', '2019-09-04 09:09:31', '2019-09-03 15:56:47', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('1a8a2941e9c24b3d7ececc582a0c81ec', '5f1bd3c0d7bf4c009cfea6b7462405e7', 'from_account', '支付帐号', null, '0', '1', 'String', '32', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '1', '1', '1', 'single', '', '', '8', 'admin', '2019-09-04 09:09:31', '2019-09-03 11:32:51', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('1ad3bd49da3a516ec98e23c7492fa328', '9f3457cb625f45448fde7974bfb45131', 'create_by', '创建人', null, '0', '1', 'string', '50', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '0', '0', 'single', '', '', '2', 'admin', '2019-09-08 11:24:38', '2019-09-03 11:16:29', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('1bd2266c273780daf3c4e6e615f9bad7', 'c6582973284a45dab2c4994b0a7bb682', 'bank_type', '银行类型', null, '0', '1', 'String', '32', '0', '', 'bank_type', '', '', 'list', '', '120', null, '0', '', '', '1', '1', '1', 'single', '', '', '8', 'admin', '2019-09-07 08:45:41', '2019-09-02 23:52:40', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('1cb22e8f932db8e7635371a20b17b901', '7ac40d2385304faeb32a65cd3deb9802', 'update_by', '更新人', null, '0', '1', 'string', '50', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '0', '0', 'single', '', '', '4', 'admin', '2019-09-01 17:26:36', '2019-09-01 16:20:05', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('1d4ed5f082aed1fd567926987710dda1', 'f52b05a17fd3402fac2a0234cf82694a', 'account_num', '帐号', null, '0', '1', 'String', '32', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '1', '1', '1', 'single', '', '', '9', 'admin', '2019-09-07 08:45:50', '2019-09-02 22:47:05', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('1e1bae0b4114ebb2484620ad45febadc', '4803dcecf97d43d7a418d1ecd007f749', 'show_in', '展示平台', null, '0', '1', 'String', '32', '0', '', 'ad_show_in', '', '', 'list', '', '120', null, '0', '', '', '1', '1', '1', 'single', '', '', '7', 'admin', '2019-09-07 16:07:29', '2019-09-04 10:53:56', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('1ee8fee8a6d1e470c03e64de0e209453', 'f52b05a17fd3402fac2a0234cf82694a', 'account_type', '帐户类型', null, '0', '1', 'String', '32', '0', '', 'account_type', '', '', 'list', '', '120', null, '0', '', '', '1', '1', '1', 'single', '', '', '8', 'admin', '2019-09-07 08:45:50', '2019-09-02 22:47:05', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('20b83824cfd42bf8dc799bf431d2d49f', '29edcae80449466fa0d29b913af7c7bd', 'mobile', '手机号码', null, '0', '1', 'String', '11', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '1', '1', '1', 'single', '', '', '9', 'admin', '2019-09-07 10:05:10', '2019-09-02 20:43:43', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('213c7d714477575aa8d7fcaa50c22ca5', '5752e059cbcc4514ab0e9a6b3de6ec8b', 'create_time', '创建日期', null, '0', '1', 'Date', '20', '0', '', '', '', '', 'datetime', '', '120', null, '0', '', '', '0', '0', '0', 'single', '', '', '3', 'admin', '2019-09
 'id', '主键', null, '1', '0', 'string', '36', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '0', '0', 'single', '', '', '1', 'admin', '2019-09-12 11:24:15', '2019-09-03 15:06:47', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('4f9813da9417a0adefb98e30f5e98deb', '137f43a9c8ae480c894465cc8b78411c', 'update_time', '更新日期', null, '0', '1', 'Date', '20', '0', '', '', '', '', 'datetime', '', '120', null, '0', '', '', '0', '0', '0', 'single', '', '', '5', 'admin', '2019-09-06 22:26:38', '2019-09-03 10:32:55', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('502d59a8f97e664a994976a005bcc335', '137f43a9c8ae480c894465cc8b78411c', 'id', '主键', null, '1', '0', 'string', '36', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '0', '0', 'single', '', '', '1', 'admin', '2019-09-06 22:26:38', '2019-09-03 10:32:55', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('51d50a3928453ee91c9765baf32984f9', '29edcae80449466fa0d29b913af7c7bd', 'superior', '上级', null, '0', '1', 'String', '32', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '1', '1', 'single', '', '', '13', 'admin', '2019-09-07 10:05:10', '2019-09-03 16:33:27', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('536f9a955eb57fe177c9355d74e30400', '5f1bd3c0d7bf4c009cfea6b7462405e7', 'account_type', '支付方式', null, '0', '1', 'String', '32', '0', '', 'account_type', '', '', 'list', '', '120', null, '0', '', '', '1', '1', '1', 'single', '', '', '7', 'admin', '2019-09-04 09:09:31', '2019-09-03 11:32:51', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('5728a0df062c55587b7a71bea184d34a', '11d3a75729c943c28a2889ec260e9ea3', 'id', '主键', null, '1', '0', 'string', '36', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '0', '0', 'single', '', '', '1', 'admin', '2019-09-08 22:51:45', '2019-09-04 08:42:32', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('57d655757aa2df4fd2bd6334472fa5f0', '079eaa69a8ce44d2bd994c0269e82b4b', 'user_id', '玩家ID', null, '0', '1', 'String', '32', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '1', '1', '1', 'single', '', '', '7', 'admin', '2019-09-07 00:05:28', '2019-09-04 10:30:02', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('5853ee29df1f0024bc14b0a89b344da1', '11d3a75729c943c28a2889ec260e9ea3', 'to_account_type', '接收平台', null, '0', '1', 'String', '32', '0', '', 'account_type', '', '', 'list', '', '120', null, '0', '', '', '1', '1', '1', 'single', '', '', '14', 'admin', '2019-09-08 22:51:46', '2019-09-04 08:45:11', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('5869579d29faebb87c2ff8610504eafa', 'f52b05a17fd3402fac2a0234cf82694a', 'create_time', '创建日期', null, '0', '1', 'Date', '20', '0', '', '', '', '', 'datetime', '', '120', null, '0', '', '', '0', '0', '0', 'single', '', '', '3', 'admin', '2019-09-07 08:45:50', '2019-09-02 22:47:05', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('591a857c154dd56d940f91808c3b9b11', '7ac40d2385304faeb32a65cd3deb9802', 'status', '状态', null, '0', '1', 'int', '32', '0', '1', 'plateform_status', '', '', 'list', '', '120', 'n', '1', '', '', '0', '1', '1', 'single', '', '', '9', 'admin', '2019-09-01 17:26:36', '2019-09-01 16:20:05', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('5aa50081be2dcbe6301357b8471a5660', '9f3457cb625f45448fde7974bfb45131', 'content', '设置内容', null, '0', '1', 'String', '32', '0', '', '', '', '', 'textarea', '', '120', null, '0', '', '', '0', '1', '1', 'single', '', '', '9', 'admin', '2019-09-08 11:24:38', '2019-09-03 11:16:29', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('5dfef9f93923520e50aede6f221ae6ca', 'b9d9b12dc4b941259a970f2eddea2660', 'from_bank_account', '支付卡号', null, '0', '1', 'String', '32', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '1', '1', '1', 'single', '', '', '8', 'admin', '2019-09-04 09:09:54', '2019-09-03 15:18:30', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('5e24d5d8cb6e36ebbe1edac7a5634c49', 'c1d9eecac62744b79464ef59614cbc1b', 'status', '帐号状态', null, '0', '1', 'String', '32', '0', '', 'account_status', '', '', 'list', '', '120', null, '0', '', '', '1', '1', '1', 'single', '', '', '10', 'admin', '2019-09-07 00:11:30', '2019-09-03 10:19:41', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('5e4e97c50429738b9f9c219e65955ada', 'e064ddb57a894ab79a8cb9db3aa82b8d', 'follower_direct_id', '一级下线ID', null, '0', '1', 'String', '32', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '1', '0', 'single', '', '', '11', 'admin', '2019-09-08 17:39:52', '2019-09-04 09:37:14', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('62b2ad843295986d1241e8c34d888099', '1a255b5c711a4b668bc080e1ef8827ac', 'star', '选择次数', null, '0', '1', 'int', '32', '0', '', '', '', '', 'text', '', '120', 'z', '0', '', '', '0', '0', '1', 'single', '', '', '11', 'admin', '2019-09-07 17:23:09', '2019-09-02 01:32:24', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('630258b2d96f41bf30174ee9da3c2eac', '89898b29258546fd877f93b81227d5fe', 'done_time', '执行时间', null, '0', '1', 'String', '32', '0', '', '', '', '', 'datetime', '', '120', null, '0', '', '', '0', '1', '1', 'single', '', '', '12', 'admin', '2019-09-08 18:34:10', '2019-09-04 09:51:09', 'admin');
INSERT INTO `onl_cgform_field` VALUES 
 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('c6247ee3e3f49a9e12bbf8cf6443ed3c', 'c1d9eecac62744b79464ef59614cbc1b', 'bank_type', '银行', null, '0', '1', 'String', '32', '0', '', 'bank_type', '', '', 'list', '', '120', null, '0', '', '', '1', '1', '1', 'single', '', '', '8', 'admin', '2019-09-07 00:11:30', '2019-09-03 10:19:41', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('c69314266372fbf0532bf767157f6cad', 'b9d9b12dc4b941259a970f2eddea2660', 'to_bank_type', '接收方银行', null, '0', '1', 'String', '32', '0', '', 'bank_type', '', '', 'list', '', '120', null, '0', '', '', '1', '1', '1', 'single', '', '', '10', 'admin', '2019-09-04 09:09:54', '2019-09-03 15:18:30', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('c6f9d9073c09cee378b8dd5dc388ee47', '4803dcecf97d43d7a418d1ecd007f749', 'show_at', '展示位置', null, '0', '1', 'String', '32', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '1', '1', 'single', '', '', '8', 'admin', '2019-09-07 16:07:29', '2019-09-04 10:53:56', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('c74a87d8a99761d8905fae174f90f185', '7648448d3af048ed8a08349577c6155c', 'create_by', '创建人', null, '0', '1', 'string', '50', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '0', '0', 'single', '', '', '2', 'admin', '2019-09-08 15:19:21', '2019-09-04 10:11:04', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('c898b3e61786e65d84dfdf27c1df0fdd', '079eaa69a8ce44d2bd994c0269e82b4b', 'content', '内容', null, '0', '1', 'String', '32', '0', '', '', '', '', 'textarea', '', '120', null, '0', '', '', '0', '1', '1', 'single', '', '', '9', 'admin', '2019-09-07 00:05:28', '2019-09-04 10:30:02', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('c9e1fdd6c4e3e4e4a74057b11819b82a', 'e064ddb57a894ab79a8cb9db3aa82b8d', 'pay_record_id', '支付记录', null, '0', '1', 'String', '32', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '1', '1', 'single', '', '', '7', 'admin', '2019-09-08 17:39:52', '2019-09-04 09:37:14', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('cc7cb87043f0f17b76103218750ab53b', 'e064ddb57a894ab79a8cb9db3aa82b8d', 'sys_org_code', '所属部门', null, '0', '1', 'string', '64', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '0', '0', 'single', '', '', '6', 'admin', '2019-09-08 17:39:52', '2019-09-04 09:37:14', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('cdde2cf88c6020937e46952a05b3e3ad', 'e064ddb57a894ab79a8cb9db3aa82b8d', 'status', '可返状态', null, '0', '1', 'String', '32', '0', '', 'can_cashback_status', '', '', 'list', '', '120', null, '0', '', '', '1', '1', '1', 'single', '', '', '10', 'admin', '2019-09-08 17:39:52', '2019-09-04 09:37:14', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('ce06e87e928e3d25de5fb2fa80de44b6', '7ac40d2385304faeb32a65cd3deb9802', 'sys_org_code', '所属部门', null, '0', '1', 'string', '64', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '0', '0', 'single', '', '', '6', 'admin', '2019-09-01 17:26:36', '2019-09-01 16:20:05', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('cf70d23804ef06bfd085025b972ab6e4', '11d3a75729c943c28a2889ec260e9ea3', 'pay_order_id', '支付订单号', null, '0', '1', 'String', '32', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '1', '1', '1', 'single', '', '', '18', 'admin', '2019-09-08 22:51:46', '2019-09-04 08:48:23', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('cffebb52c194213fbd3944e489affa66', 'e064ddb57a894ab79a8cb9db3aa82b8d', 'cash_back_num', '可返金额', null, '0', '1', 'String', '32', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '1', '1', 'single', '', '', '9', 'admin', '2019-09-08 17:39:52', '2019-09-04 09:37:14', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('d01949030c93821b4064d9b2122e7b20', '5f1bd3c0d7bf4c009cfea6b7462405e7', 'from_user_id', '支付方ID', null, '0', '1', 'String', '32', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '1', '1', 'single', '', '', '9', 'admin', '2019-09-04 09:09:31', '2019-09-03 15:03:34', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('d0ad8d654f976e025b58384331fa5a5d', 'b9d9b12dc4b941259a970f2eddea2660', 'from_user_id', '支付方ID', null, '0', '1', 'String', '32', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '1', '1', 'single', '', '', '9', 'admin', '2019-09-04 09:09:54', '2019-09-03 15:18:30', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('d0b4e5768f4c676e473cd562c0e8a129', '5f1bd3c0d7bf4c009cfea6b7462405e7', 'order_id', '第三方订单ID', null, '0', '1', 'String', '32', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '1', '1', 'single', '', '', '14', 'admin', '2019-09-04 09:09:31', '2019-09-03 15:56:47', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('d0dad8fd0e795502690b99b80b96861e', '5f1bd3c0d7bf4c009cfea6b7462405e7', 'create_time', '创建日期', null, '0', '1', 'Date', '20', '0', '', '', '', '', 'datetime', '', '120', null, '0', '', '', '0', '0', '0', 'single', '', '', '3', 'admin', '2019-09-04 09:09:31', '2019-09-03 11:32:51', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('d1fdc283947134af2c3fc8176135fa1a', '137f43a9c8ae480c894465cc8b78411c', 'create_time', '创建日期', null, '0', '1', 'Date', '20', '0', '', '', '', '', 'datetime', '', '120', null, '0', '', '', '0', '0', '0', 'single', '', '', '3', 'admin', '2019-09-06 22:26:38', '2019-09-03 10:32:55', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('d2729df7fb6cd0bc5f9c3dd7dfd06c26', 'f52b05a17fd3402fac2a0234cf82694a', 'update_by', '更新人', null, '0', '1', 'string', '50', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '0', '0', 'single', '', '', '4', 'admin', '2019-09-07 08:45:50', '2019-09-02 22:47:05', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('d52ef23665387e49807251863ce08ead', '9f3457cb625f45448fde7974bfb45131', 'id', '主键', null, '1', '0', 'string', '36', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '0', '0', 'single', '', '', '1', 'admin', '2019-09-08 11:24:38', '2019-09-03 11:16:29', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('d6f27a956b024be326bd7b05e15a71ef', '5752e059cbcc4514ab0e9a6b3de6ec8b', 'create_by', '创建人', null, '0', '1', 'string', '50', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '0', '0', 'single', '', '', '2', 'admin', '2019-09-12 11:24:15', '2019-09-03 15:06:47', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('d8482e55ecb9763e1d4fe12a869b3cd7', 'c6582973284a45dab2c4994b0a7bb682', 'create_time', '创建日期', null, '0', '1', 'Date', '20', '0', '', '', '', '', 'datetime', '', '120', null, '0', '', '', '0', '0', '0', 'single', '', '', '3', 'admin', '2019-09-07 08:45:41', '2019-09-02 23:52:40', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES 
 'Y', 'Y', 'N', null, 'UUID', 'single', null, null, null, null, null, null, 'bdfl_ptbd', '1', null, 'admin', '2019-09-03 10:33:07', 'admin', '2019-09-03 10:32:55');
INSERT INTO `onl_cgform_head` VALUES ('1a255b5c711a4b668bc080e1ef8827ac', 'mj_game', '1', '16', '游戏平台', 'Y', 'Y', 'Y', 'N', null, 'UUID', 'single', null, null, null, null, null, null, 'bdfl_ptbd', '1', null, 'admin', '2019-09-01 17:44:00', 'admin', '2019-09-01 17:43:49');
INSERT INTO `onl_cgform_head` VALUES ('29edcae80449466fa0d29b913af7c7bd', 'mj_player', '1', '22', '游戏玩家', 'Y', 'Y', 'Y', 'N', null, 'UUID', 'single', null, 'mj_player_account,mj_player_card,mj_player_game', null, null, null, null, 'bdfl_include', '3', null, 'admin', '2019-09-02 22:25:36', 'admin', '2019-09-02 20:43:43');
INSERT INTO `onl_cgform_head` VALUES ('4803dcecf97d43d7a418d1ecd007f749', 'ad', '1', '14', '广告', 'N', 'Y', 'Y', 'N', null, 'UUID', 'single', null, null, null, null, null, null, 'bdfl_ptbd', '2', null, 'admin', '2019-09-04 10:54:22', 'admin', '2019-09-04 10:53:56');
...
INSERT INTO `onl_cgform_head` VALUES ('5752e059cbcc4514ab0e9a6b3de6ec8b', 'mj_pay_picture', '1', '9', '支付图片', 'N', 'Y', 'Y', 'N', null, 'UUID', 'single', null, null, null, null, null, null, 'bdfl_ptbd', '1', null, 'admin', '2019-09-03 15:10:45', 'admin', '2019-09-03 15:06:47');
INSERT INTO `onl_cgform_head` VALUES ('7648448d3af048ed8a08349577c6155c', 'mj_player_game', '1', '18', '可用游戏', 'N', 'Y', 'Y', 'N', null, 'UUID', 'single', '0', null, '3', null, null, null, 'bdfl_ptbd', '1', null, 'admin', '2019-09-04 10:11:44', 'admin', '2019-09-04 10:11:04');
INSERT INTO `onl_cgform_head` VALUES ('89898b29258546fd877f93b81227d5fe', 'mj_cash_back_record', '1', '19', '返现记录', 'N', 'Y', 'Y', 'N', null, 'UUID', 'single', null, null, null, null, null, null, 'bdfl_include', '2', null, 'admin', '2019-09-04 09:53:14', 'admin', '2019-09-04 09:51:09');
INSERT INTO `onl_cgform_head` VALUES ('9f3457cb625f45448fde7974bfb45131', 'mj_conf', '1', '4', '游戏设置', 'N', 'Y', 'Y', 'N', null, 'UUID', 'single', null, null, null, null, null, null, 'bdfl_ptbd', '1', null, 'admin', '2019-09-03 11:16:38', 'admin', '2019-09-03 11:16:29');
INSERT INTO `onl_cgform_head` VALUES ('c1d9eecac62744b79464ef59614cbc1b', 'mj_card', '1', '9', '平台收款银行卡', 'Y', 'Y', 'Y', 'N', null, 'UUID', 'single', null, null, null, null, null, null, 'bdfl_ptbd', '1', null, 'admin', '2019-09-03 10:20:43', 'admin', '2019-09-03 10:19:41');
INSERT INTO `onl_cgform_head` VALUES ('c6582973284a45dab2c4994b0a7bb682', 'mj_player_card', '1', '25', '玩家银行卡', 'N', 'Y', 'N', 'N', null, 'UUID', 'single', '0', null, '2', null, null, null, 'bdfl_ptbd', '1', null, 'admin', '2019-09-02 23:53:02', 'admin', '2019-09-02 23:52:40');
...
INSERT INTO `onl_cgform_head` VALUES ('e064ddb57a894ab79a8cb9db3aa82b8d', 'mj_cash_back_can', '1', '11', '可返记录', 'Y', 'Y', 'Y', 'N', null, 'UUID', 'single', null, null, null, null, null, null, 'bdfl_include', '2', null, 'admin', '2019-09-04 09:40:53', 'admin', '2019-09-04 09:37:14');
INSERT INTO `onl_cgform_head` VALUES ('f52b05a17fd3402fac2a0234cf82694a', 'mj_player_account', '1', '40', '玩家帐号', 'Y', 'Y', 'N', 'N', null, 'UUID', 'single', '0', null, '1', null, null, null, 'bdfl_ptbd', '1', null, 'admin', '2019-09-02 22:50:46', 'admin', '2019-09-02 22:47:05');
...
INSERT INTO `sys_announcement_send` VALUES ('548eadd8e870380ca25517747e1d4735', '93a9060a1c20e4bf98b3f768a02c2ff9', 'a75d45a015c44384a04449ee80dc3503', '1', '2019-08-29 07:58:51', 'jeecg', '2019-08-29 07:50:38', 'jeecg', '2019-08-29 07:58:51');
...
INSERT INTO `sys_dict` VALUES ('0d70c6bb184398dc5ceef88f530e17f2', '平台状态', 'plateform_status', '平台上线状态', '0', 'admin', '2019-09-01 16:32:36', null, null, '0');
INSERT INTO `sys_dict` VALUES ('0e07745e66eddf6005a71d221d7fbdcf', '返现状态', 'cashback_status', '返现状态', '0', 'admin', '2019-09-04 09:54:15', 'admin', '2019-09-07 00:15:56', '0');
...
INSERT INTO `sys_dict` VALUES ('34ef46e5bbc621698f6d50c96a2fc37d', '广告状态', 'ad_status', '广告状态', '0', 'admin', '2019-09-04 10:58:06', null, null, '0');
INSERT INTO `sys_dict` VALUES ('394750051c69b904c11c62b724c0866e', '消息通知方式', 'notice_type', '消息通知方式', '0', 'admin', '2019-09-04 10:22:51', null, null, '0');
...
INSERT INTO `sys_dict` VALUES ('63dccb0695b0afe2fd5de96bbbad903e', '第三方帐号平台', 'account_type', '第三方帐号平台', '0', 'admin', '2019-09-02 22:49:13', null, null, '0');
...
INSERT INTO `sys_dict` VALUES ('6b5f2f91f03f6871d66f55b0467ba7dc', '银行类型', 'bank_type', '', '0', 'admin', '2019-09-02 23:44:43', null, null, '0');
...
INSERT INTO `sys_dict` VALUES ('71ffbe278ef77f2586caa1720ed4e34d', '支付图片状态', 'pay_picture_status', '', '0', 'admin', '2019-09-03 15:07:36', null, null, '0');
...
INSERT INTO `sys_dict` VALUES ('77b8eb38e488075e5e05687e58c817b0', '可返状态', 'can_cashback_status', '可返状态', '0', 'admin', '2019-09-04 09:38:00', 'admin', '2019-09-07 00:25:24', '0');
...
INSERT INTO `sys_dict` VALUES ('7c0ba044977f581e065ad3e8317f13e4', '支付收入', 'pay_type', '支付收入标识', '0', 'admin', '2019-09-04 08:51:34', null, null, '0');
...
INSERT INTO `sys_dict` VALUES ('9932ffe263b4fda01d5acaf9d6fd095f', '会员级别', 'account_lever', '玩家会员级别', '0', 'admin', '2019-09-03 10:47:08', null, null, '0');
INSERT INTO `sys_dict` VALUES ('9afb79abd5cb6f873ae870451f039102', '支付动作', 'pay_action', '支付动作', '0', 'admin', '2019-09-12 00:09:51', 'admin', '2019-09-12 00:10:10', '0');
...
INSERT INTO `sys_dict` VALUES ('adfbd470cdb8823c7b2184d82fc5bb79', '消息状态', 'notice_status', '消息状态', '0', 'admin', '2019-09-04 10:30:46', null, null, '0');
...
INSERT INTO `sys_dict` VALUES ('d7de2086500943ed1dcf4fb0909b007d', '帐号状态', 'account_status', '', '0', 'admin', '2019-09-02 22:51:26', 'admin', '2019-09-02 22:51:54', '0');
INSERT INTO `sys_dict` VALUES ('ebc1ccca7206b6c1f8fc8beaf71e4eff', '广告展示平台', 'ad_show_in', '广告展示平台', '0', 'admin', '2019-09-04 10:55:33', null, null, '0');
...
INSERT INTO `sys_dict_item` VALUES ('01dd2231d6e036d4eab566b638508965', 'd7de2086500943ed1dcf4fb0909b007d', '正常', '1', '', '1', '1', 'admin', '2019-09-02 22:52:11', null, null);
...
INSERT INTO `sys_dict_item` VALUES ('1aaaf4563796df4409193c3f8894cc68', '9afb79abd5cb6f873ae870451f039102', '黄金->钻石', '6', '', '6', '1', 'admin', '2019-09-12 00:13:54', null, null);
...
INSERT INTO `sys_dict_item` VALUES ('1d0ec5cf81216351753e4562343887ad', 'adfbd470cdb8823c7b2184d82fc5bb79', '已查阅', '2', '用于平台内消息', '2', '1', 'admin', '2019-09-04 10:31:23', 'admin', '2019-09-04 10:31:57');
...
INSERT INTO `sys_dict_item` VALUES ('1fee404aeec2fea909108b65ec471dd4', '0d70c6bb184398dc5ceef88f530e17f2', '维护中', '2', '平台正在维护', '2', '1', 'admin', '2019-09-01 16:39:09', 'admin', '2019-09-01 17:53:50');
...
INSERT INTO `sys_dict_item` VALUES ('28363520fdd648c530698ef04aaa491d', 'd7de2086500943ed1dcf4fb0909b007d', '删除', '3', '', '3', '1', 'admin', '2019-09-02 22:53:13', null, null);
INSERT INTO `sys_dict_item` VALUES ('2c119e017fbad36f1f895df7a7535136', '394750051c69b904c11c62b724c0866e', '短信', '2', '', '2', '1', 'admin', '2019-09-04 10:23:34', null, null);
...
INSERT INTO `sys_dict_item` VALUES ('30038753a1dcd0a88a3a8a07a392833c', '77b8eb38e488075e5e05687e58c817b0', '已申请', '2', '', '2', '1', 'admin', '2019-09-04 09:40:08', null, null);
...
INSERT INTO `sys_dict_item` VALUES ('4a25d640a10a8da8275d845c6d1348af', '0d70c6bb184398dc5ceef88f530e17f2', '正常', '1', '平台正常在线', '1', '1', 'admin', '2019-09-01 16:38:04', null, null);
...
INSERT INTO `sys_dict_item` VALUES ('50d36a4aad3cae3231b4b30e1a62e208', '71ffbe278ef77f2586caa1720ed4e34d', '已上传', '1', '', '1', '1', 'admin', '2019-09-03 15:08:55', null, null);
...
INSERT INTO `sys_dict_item` VALUES ('5409cf7e8893ad6f24c2a1daacfaa877', '9932ffe263b4fda01d5acaf9d6fd095f', '白银会员', '2', '', '2', '1', 'admin', '2019-09-03 10:48:05', null, null);
...
INSERT INTO `sys_dict_item` VALUES ('5efb6449c61d9df8a0efd8ae78508df1', '7c0ba044977f581e065ad3e8317f13e4', '收入', '1', '', '1', '1', 'admin', '2019-09-04 08:51:57', null, null);
INSERT INTO `sys_dict_item` VALUES ('65ff48f001a61fd5df5759bfe9d79146', '0d70c6bb184398dc5ceef88f530e17f2', '停运', '3', '平台停止运营', '3', '1', 'admin', '2019-09-01 16:40:34', null, null);
...
INSERT INTO `sys_dict_item` VALUES ('6b8e45ad96ba6e63fca7f7f480817d4c', 'adfbd470cdb8823c7b2184d82fc5bb79', '已发送', '3', '用于短信方式', '3', '1', 'admin', '2019-09-04 10:31:47', null, null);
...
INSERT INTO `sys_dict_item` VALUES ('6feada818cb32ec8c90caeda5b8c51da', 'd7de2086500943ed1dcf4fb0909b007d', '冻结', '2', '', '2', '1', 'admin', '2019-09-02 22:52:38', null, null);
...
INSERT INTO `sys_dict_item` VALUES ('752b8ec7e29ce81b7f28ecb563d04276', '71ffbe278ef77f2586caa1720ed4e34d', '已作废', '4', '确认存在问题', '4', '1', 'admin', '2019-09-09 07:50:27', 'admin', '2019-09-12 08:34:01');
...
INSERT INTO `sys_dict_item` VALUES ('7666b6d95ec3872d2f1369912c40d865', '34ef46e5bbc621698f6d50c96a2fc37d', '下线', '2', '广告不投放', '2', '1', 'admin', '2019-09-04 10:59:32', null, null);
...
INSERT INTO `sys_dict_item` VALUES ('7c4ff7b46cab2b854764fcfe0801f5a6', '9932ffe263b4fda01d5acaf9d6fd095f', '普通会员', '1', '', '1', '1', 'admin', '2019-09-03 10:47:50', null, null);
...
INSERT INTO `sys_dict_item` VALUES ('7f05feb460654304a25119cdcc23f5e3', '9afb79abd5cb6f873ae870451f039102', '普通->白银', '1', '', '1', '1', 'admin', '2019-09-12 00:11:14', null, null);
...
INSERT INTO `sys_dict_item` VALUES ('83cfac82717c2c56f007965f4dc104d7', '9afb79abd5cb6f873ae870451f039102', '普通->黄金', '2', '', '2', '1', 'admin', '2019-09-12 00:11:39', null, null);
...
INSERT INTO `sys_dict_item` VALUES ('887ddfebaf1c9d8b4e15ff36509931b5', '0e07745e66eddf6005a71d221d7fbdcf', '已执行', '3', '', '3', '1', 'admin', '2019-09-04 09:55:15', null, null);
...
INSERT INTO `sys_dict_item` VALUES ('8e4dc3b6b6ea1fb62a40909877f36ecf', '6b5f2f91f03f6871d66f55b0467ba7dc', '中国工商银行', '2', '', '1', '1', 'admin', '2019-09-02 23:45:51', null, null);
...
INSERT INTO `sys_dict_item` VALUES ('951d812662959c5fa956d6d32679474a', '394750051c69b904c11c62b724c0866e', '平台内消息', '1', '', '1', '1', 'admin', '2019-09-04 10:23:19', null, null);
...
INSERT INTO `sys_dict_item` VALUES ('a4ccb0a76ed8bcdfda6ed66952a68bf1', 'd7de2086500943ed1dcf4fb0909b007d', '使用中', '5', '', '5', '1', 'admin', '2019-09-03 10:23:28', null, null);
INSERT INTO `sys_dict_item` VALUES ('a799d7065d163fbef4a2547b3c4a17a9', '63dccb0695b0afe2fd5de96bbbad903e', '支付宝', 'zfb', '', '2', '1', 'admin', '2019-09-02 22:50:09', 'admin', '2019-09-08 15:52:45');
...
INSERT INTO `sys_dict_item` VALUES ('ac9c22a25d5a6b47ae0a5df44fe5f5c8', '6b5f2f91f03f6871d66f55b0467ba7dc', '中国农业银行', '1', '', '1', '1', 'admin', '2019-09-02 23:45:37', null, null);
...
INSERT INTO `sys_dict_item` VALUES ('adcfcd6416e789d97ffbdba8c4dd11ef', '34ef46e5bbc621698f6d50c96a2fc37d', '上线', '1', '', '1', '1', 'admin', '2019-09-04 10:58:32', 'admin', '2019-09-04 10:59:52');
INSERT INTO `sys_dict_item` VALUES ('af0d091a8af288e4713c0a4630386b3a', '9afb79abd5cb6f873ae870451f039102', '普通->钻石', '3', '', '3', '1', 'admin', '2019-09-12 00:12:00', null, null);
...
INSERT INTO `sys_dict_item` VALUES ('bb17675176610d32e1731971f2a1e00f', '77b8eb38e488075e5e05687e58c817b0', '等待中', '1', '', '1', '1', 'admin', '2019-09-04 09:39:53', null, null);
...
INSERT INTO `sys_dict_item` VALUES ('be8f9c0f4d158614e917745060fa4c86', '71ffbe278ef77f2586caa1720ed4e34d', '待核实', '3', '支付图片存在问题，需要核实', '3', '1', 'admin', '2019-09-09 07:50:05', null, null);
INSERT INTO `sys_dict_item` VALUES ('c1023386858de3e3381a8be20aca7b8e', '63dccb0695b0afe2fd5de96bbbad903e', '微信', 'wx', '', '1', '1', 'admin', '2019-09-02 22:49:53', 'admin', '2019-09-08 15:52:36');
...
INSERT INTO `sys_dict_item` VALUES ('cac0a21fcc372c1da7fb4d37b00798f3', '0e07745e66eddf6005a71d221d7fbdcf', '已审核', '2', '', '2', '1', 'admin', '2019-09-04 09:54:53', null, null);
...
INSERT INTO `sys_dict_item` VALUES ('d39ee0bc9b75978c1dadcd8f216fc991', '7c0ba044977f581e065ad3e8317f13e4', '支出', '2', '', '2', '1', 'admin', '2019-09-04 08:52:08', null, null);
INSERT INTO `sys_dict_item` VALUES ('d8c6136b1356cbd407b21db7b1077009', 'ebc1ccca7206b6c1f8fc8beaf71e4eff', '雀神', 'mj', '', '1', '1', 'admin', '2019-09-04 10:56:24', null, null);
INSERT INTO `sys_dict_item` VALUES ('db00ce371dce243ac558c1184b3ad0b5', '9932ffe263b4fda01d5acaf9d6fd095f', '钻石会员', '4', '', '4', '1', 'admin', '2019-09-03 10:48:39', null, null);
INSERT INTO `sys_dict_item` VALUES ('deb415b7f9b16ebcf3bea76c7aa41d6c', '9afb79abd5cb6f873ae870451f039102', '白银->钻石', '5', '', '5', '1', 'admin', '2019-09-12 00:13:19', 'admin', '2019-09-12 00:13:40');
...
INSERT INTO `sys_dict_item` VALUES ('dfbc87758e9bc6bd548d197da0f4073c', '9afb79abd5cb6f873ae870451f039102', '白银->黄金', '4', '', '4', '1', 'admin', '2019-09-12 00:12:54', null, null);
INSERT INTO `sys_dict_item` VALUES ('e5e934c854c341fd13e07c43db0fd419', 'adfbd470cdb8823c7b2184d82fc5bb79', '待发送', '1', '', '1', '1', 'admin', '2019-09-04 10:31:08', null, null);
...
INSERT INTO `sys_dict_item` VALUES ('e750473e4a1fea26e118d58b31b25c36', '0e07745e66eddf6005a71d221d7fbdcf', '已申请', '1', '', '1', '1', 'admin', '2019-09-04 09:54:31', null, null);
...
INSERT INTO `sys_dict_item` VALUES ('ea7a6ea50ac32aa24d6ebad32e5b1ec9', 'd7de2086500943ed1dcf4fb0909b007d', '停用', '4', '', '4', '1', 'admin', '2019-09-03 10:21:25', null, null);
INSERT INTO `sys_dict_item` VALUES ('eb67fe747bc0707277591b3d93a3af24', '71ffbe278ef77f2586caa1720ed4e34d', '已处理', '2', '', '1', '1', 'admin', '2019-09-03 15:09:14', 'admin', '2019-09-03 15:10:16');
...
INSERT INTO `sys_dict_item` VALUES ('fcca21df6d2add33db5d8be5264f677d', '9932ffe263b4fda01d5acaf9d6fd095f', '黄金会员', '3', '', '3', '1', 'admin', '2019-09-03 10:48:21', null, null);
...
INSERT INTO `sys_dict_item` VALUES ('ff0af0baa5d169367effad2a6ddacbfd', '6b5f2f91f03f6871d66f55b0467ba7dc', '招商银行', '3', '', '3', '1', 'admin', '2019-09-02 23:47:21', null, null);
...
INSERT INTO `sys_log` VALUES ('ddacbccb6765bc9c84b5887d209e8472', '1', '用户名: jeecg,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-08-29 07:50:33', null, null);
INSERT INTO `sys_log` VALUES ('e3730f21908d7b5449de42ffcbe8143a', '1', '用户名: jeecg,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-08-29 18:28:10', null, null);
INSERT INTO `sys_log` VALUES ('0f2c72cfd3ad9157249cee0753c10c86', '1', '用户名: jeecg,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-08-29 18:29:15', null, null);
INSERT INTO `sys_log` VALUES ('5b2f25c0a6d64d497480cc4e17810432', '1', '用户名: jeecg,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-08-30 08:59:36', null, null);
INSERT INTO `sys_log` VALUES ('72de3e125b39694a1682de899e5d43ce', '1', '用户名: jeecg,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-08-30 09:00:13', null, null);
INSERT INTO `sys_log` VALUES ('fe981fce9473369db8f60faaf1e1cb95', '1', '用户名: jeecg,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-08-31 08:16:31', null, null);
INSERT INTO `sys_log` VALUES ('819c82ea5468c040a33958d890715e5f', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-08-31 08:17:10', null, null);
INSERT INTO `sys_log` VALUES ('d776b2a0afac58f412415692ff88ac6b', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-01 14:57:59', null, null);
INSERT INTO `sys_log` VALUES ('4845712e92e5f1344ee761d4fd5c8893', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-01 16:07:13', null, null);
INSERT INTO `sys_log` VALUES ('b123a8fa2e462ba7f62c033c8bef213d', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-02 01:07:10', null, null);
INSERT INTO `sys_log` VALUES ('69087fb7c7a9b776dbc18a4e40f7a837', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-02 01:09:25', null, null);
INSERT INTO `sys_log` VALUES ('e62130a53d1f9babbe96ec61537922bf', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-02 10:01:29', null, null);
INSERT INTO `sys_log` VALUES ('8bdbcdc5104c4629afc2c579261f1716', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-02 10:01:55', null, null);
INSERT INTO `sys_log` VALUES ('83282ef6652841b21b373427faefbc1e', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-02 11:03:00', null, null);
INSERT INTO `sys_log` VALUES ('fa0efbd877bb37aabcc9375dac0f43d3', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-02 11:03:31', null, null);
INSERT INTO `sys_log` VALUES ('faa85a46fc7a324623866518e314ea8c', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-02 18:14:51', null, null);
INSERT INTO `sys_log` VALUES ('9b6a11286c29f853d7b9ca52e519604c', '1', '用户名: jeecg,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-02 18:15:08', null, null);
INSERT INTO `sys_log` VALUES ('a539a25be63b5263835c5b53e1608baa', '1', '用户名: jeecg,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-02 20:19:38', null, null);
INSERT INTO `sys_log` VALUES ('7ca6354cea0caa5e89cfd889c17d9a56', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-02 20:20:01', null, null);
INSERT INTO `sys_log` VALUES ('0ed3584744437506a561543d7cb3e901', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-02 22:24:38', null, null);
INSERT INTO `sys_log` VALUES ('f82038ef36585f02ad636568b2bb5346', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-02 22:24:58', null, null);
INSERT INTO `sys_log` VALUES ('2a25b22e8ec307e867f4be18e4b5e187', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-03 10:09:28', null, null);
INSERT INTO `sys_log` VALUES ('df458fb59fac83ef17b369aefd9aca8e', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-03 14:57:13', null, null);
INSERT INTO `sys_log` VALUES ('0e82d1d8ee23cdb100b37223b93a6ab3', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-03 16:31:35', null, null);
INSERT INTO `sys_log` VALUES ('62980a857e15869c0f22150702f48d19', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-04 08:26:18', null, null);
INSERT INTO `sys_log` VALUES ('8814fe53c29b064db22851e70a4cbe92', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-04 08:26:37', null, null);
INSERT INTO `sys_log` VALUES ('30350b7ef1ca9aa0d9557fb3271e131c', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-04 12:01:34', null, null);
INSERT INTO `sys_log` VALUES ('d51f852bfc016669bf78a6dfe10bd473', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-04 12:01:58', null, null);
INSERT INTO `sys_log` VALUES ('1d423aa1ada3c59411baee7d4f5fdcfa', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-04 14:34:43', null, null);
INSERT INTO `sys_log` VALUES ('9622c81eec662759486117e4e56b66f0', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-05 21:23:11', null, null);
INSERT INTO `sys_log` VALUES ('f7072a824fb9f240023b62259cb1747e', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-05 21:23:19', null, null);
INSERT INTO `sys_log` VALUES ('b06d22dcb1e3bae878d8af725220b9a3', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-06 09:49:55', null, null);
INSERT INTO `sys_log` VALUES ('5c303863abfdd9a0f0f69604218779c3', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-06 09:51:10', null, null);
INSERT INTO `sys_log` VALUES ('4ab622a46b9f5f97654d49d650c33bf1', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-06 17:09:36', null, null);
INSERT INTO `sys_log` VALUES ('64dc96d5a848378658190a62d8d993e4', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-06 17:09:51', null, null);
INSERT INTO `sys_log` VALUES ('b20b55c6b7a489cd5fdc3b7df579b12a', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-06 17:30:45', null, null);
INSERT INTO `sys_log` VALUES ('5f1bddec7524ee2eae2261b157cae78b', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-06 17:31:10', null, null);
INSERT INTO `sys_log` VALUES ('64e3fd70a09954fedd8ff0bd1b04ca8c', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-06 17:36:51', null, null);
INSERT INTO `sys_log` VALUES ('fa5843cf0bcad7db23ff038b4e16a7ee', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-06 17:37:53', null, null);
INSERT INTO `sys_log` VALUES ('58b4f642c8586ee26a67696253478ca6', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-06 18:17:06', null, null);
INSERT INTO `sys_log` VALUES ('70af42a1c1386cb10f493ac75c687352', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-06 18:17:55', null, null);
INSERT INTO `sys_log` VALUES ('e24d48cdd28b3c110e93be691deb4019', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-06 18:25:16', null, null);
INSERT INTO `sys_log` VALUES ('7472ff4d7ee3cb550b5fe70a58257ed7', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-06 18:25:46', null, null);
INSERT INTO `sys_log` VALUES ('6b1d29702b9e44f1c532ba9b5386ea7c', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-06 21:45:57', null, null);
INSERT INTO `sys_log` VALUES ('88a70f89a1f79b262e9a14a3a5fc6971', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-06 21:47:05', null, null);
INSERT INTO `sys_log` VALUES ('22966f0d17406ee8c14245161296707c', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-06 23:14:32', null, null);
INSERT INTO `sys_log` VALUES ('48b1f47c752ca9dec8183f2f51ffec62', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-06 23:14:52', null, null);
INSERT INTO `sys_log` VALUES ('7a2510ac6090b33a2a29ce2c1ec8493b', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-06 23:44:27', null, null);
INSERT INTO `sys_log` VALUES ('f612e07728408330992ab621281d7f7f', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-06 23:45:02', null, null);
INSERT INTO `sys_log` VALUES ('1ec552114ad99e1de1e606e5d4bc4c3c', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-06 23:56:14', null, null);
INSERT INTO `sys_log` VALUES ('40a074c1483ae374fd993b690ce3157d', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-06 23:57:36', null, null);
INSERT INTO `sys_log` VALUES ('d409e477000dd9a7f1d79be808fa3444', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-07 00:21:10', null, null);
INSERT INTO `sys_log` VALUES ('f2226b4df39f4da7593d287b351d224a', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-07 00:21:35', null, null);
INSERT INTO `sys_log` VALUES ('a3181424926677c2050d8f2d78fcd4a1', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-07 08:13:32', null, null);
INSERT INTO `sys_log` VALUES ('9777d1734910eb598068eb17b3ce129c', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-07 08:14:00', null, null);
INSERT INTO `sys_log` VALUES ('fd612802169f09125a757a8b330c6a2e', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-07 08:58:36', null, null);
INSERT INTO `sys_log` VALUES ('33abee42656489c7d988ea00a2009eee', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-07 08:58:49', null, null);
INSERT INTO `sys_log` VALUES ('6fe49572ef6f7a1e4735beef9481fe64', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-07 15:02:33', null, null);
INSERT INTO `sys_log` VALUES ('69e99a72f7047f42a157c5e8649d7009', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-07 15:02:42', null, null);
INSERT INTO `sys_log` VALUES ('508434cc6715273ef8a9ef7de91f0dea', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-07 17:20:41', null, null);
INSERT INTO `sys_log` VALUES ('3b2a4e6f48498cc148f6d597f49c9a2a', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-07 17:21:00', null, null);
INSERT INTO `sys_log` VALUES ('e29c2523b87757e10c695186cd207f1c', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-07 22:27:41', null, null);
INSERT INTO `sys_log` VALUES ('b90349ae1929a0559783b3086fc4c049', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-07 23:54:25', null, null);
INSERT INTO `sys_log` VALUES ('61cc6100ebd304bbe97000461ab132d8', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-08 07:58:49', null, null);
INSERT INTO `sys_log` VALUES ('e669bb488f4db963cae864d757ad975c', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-08 11:23:32', null, null);
INSERT INTO `sys_log` VALUES ('1bbd5d072cb292d7b90bf35a8afe4ae1', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-08 12:35:03', null, null);
INSERT INTO `sys_log` VALUES ('c488689cb993375efb760e345b6504b8', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-08 12:35:24', null, null);
INSERT INTO `sys_log` VALUES ('ff4897d5ad60bcff785c7bb4a97b538f', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-08 14:12:01', null, null);
INSERT INTO `sys_log` VALUES ('a5b1df947a25aa79baf0c9356c83c109', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-08 14:12:14', null, null);
INSERT INTO `sys_log` VALUES ('7ec631592459102d295d12cc8875dbcc', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-08 14:54:33', null, null);
INSERT INTO `sys_log` VALUES ('aece80343608928cd989b79620159742', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-08 14:55:04', null, null);
INSERT INTO `sys_log` VALUES ('4a483a49cd100f09d65833e3f7bbadb1', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-08 15:17:44', null, null);
INSERT INTO `sys_log` VALUES ('2f56909e03711d4bd714902215ba1c89', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-08 15:18:50', null, null);
INSERT INTO `sys_log` VALUES ('2750f505c2c4a201752eea8d09ca10e1', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-08 17:38:18', null, null);
INSERT INTO `sys_log` VALUES ('ca0d32c37b75eae27fcf520fe7041be2', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-08 17:38:42', null, null);
INSERT INTO `sys_log` VALUES ('776ae07eeb34946be73fb0e71e9b0017', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-08 18:33:13', null, null);
INSERT INTO `sys_log` VALUES ('8525dd179b8f9138dccdea110d4e0ab5', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-08 18:33:42', null, null);
INSERT INTO `sys_log` VALUES ('19c53e49b8a069eca8af28627e552762', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-08 20:37:45', null, null);
INSERT INTO `sys_log` VALUES ('40026032f0b92453e32004fd2c4318ec', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-08 20:38:02', null, null);
INSERT INTO `sys_log` VALUES ('68af2b7f4e1bc9eacaa894f5ea3b1c27', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-08 20:39:56', null, null);
INSERT INTO `sys_log` VALUES ('b891c4e8c33a1f4aa1f10151126132ae', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-08 20:40:34', null, null);
INSERT INTO `sys_log` VALUES ('349827f13b16ad5bcf9f019dec7a232b', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-08 21:29:59', null, null);
INSERT INTO `sys_log` VALUES ('96b557ceb89c4c72a11bcd1139b8bc34', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-08 21:42:55', null, null);
INSERT INTO `sys_log` VALUES ('26fba54482f9c5226c651e1d5013b4dd', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-08 21:43:00', null, null);
INSERT INTO `sys_log` VALUES ('0649b4805c89f0c003f6483de3e08e35', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-08 22:37:26', null, null);
INSERT INTO `sys_log` VALUES ('9220c6895c5b799535a525107fc216fb', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-08 22:37:26', null, null);
INSERT INTO `sys_log` VALUES ('522b2ac371d3ed09ed5de0d08b011acd', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-08 22:37:30', null, null);
INSERT INTO `sys_log` VALUES ('f2a275b69dec9fccc709c7c9a597815a', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-09 07:24:59', null, null);
INSERT INTO `sys_log` VALUES ('3c673ba41f20066945a481fb088ee0dd', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-09 07:48:35', null, null);
INSERT INTO `sys_log` VALUES ('feeefbd274f1f9ff7080b0de526278e4', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-09 07:48:50', null, null);
INSERT INTO `sys_log` VALUES ('57ae4e2db626bebc68ceeba1dd816114', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-09 09:08:05', null, null);
INSERT INTO `sys_log` VALUES ('22a4661b9763f7f56f581a678dfe1d95', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-12 00:08:48', null, null);
INSERT INTO `sys_log` VALUES ('82b9f6e0436bd0ef6259064caa4fe1eb', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-12 00:08:51', null, null);
INSERT INTO `sys_log` VALUES ('ea6cb4a316fd18509fc04a9d694f3f20', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-12 08:26:16', null, null);
INSERT INTO `sys_log` VALUES ('8e0d52f2ecf2a42ab5b206628c20ff91', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-12 08:26:19', null, null);
INSERT INTO `sys_log` VALUES ('a9283067333943c700742947769e7215', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-12 09:28:17', null, null);
INSERT INTO `sys_log` VALUES ('210224cf32dac3760896b05365485440', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-12 09:28:20', null, null);
INSERT INTO `sys_log` VALUES ('7cec2568685b149412efca82325fdabd', '1', '用户名: 管理员,退出成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-12 11:23:11', null, null);
INSERT INTO `sys_log` VALUES ('1c64353eaef19f3c2d1eb49dea66bd7e', '1', '用户名: admin,登录成功！', null, null, null, '127.0.0.1', null, null, null, null, null, 'jeecg', '2019-09-12 11:23:32', null, null);
...
INSERT INTO `sys_permission` VALUES ('04b6b9218c0ca9f008b21b5cebdbe4cb', '13a0e4c46a99956339f0e4d2a30d10d3', '游戏玩家', '/helper.mj/mjPlayer', 'helper/mj/MjPlayerList', null, null, '1', null, '1', '2', '0', null, '1', '1', '0', '0', null, 'admin', '2019-09-06 22:01:35', 'admin', '2019-09-06 22:05:32', '0', '0', '1');
...
INSERT INTO `sys_permission` VALUES ('13a0e4c46a99956339f0e4d2a30d10d3', null, '雀神助手', '/helper.mj', 'layouts/RouteView', null, null, '0', null, '1', '1', '0', 'crown', '1', '0', '0', '0', null, 'admin', '2019-09-06 21:59:59', null, null, '0', '0', '1');
...
INSERT INTO `sys_permission` VALUES ('20407579ea9e2ab7b7c076dc07f4db57', '13a0e4c46a99956339f0e4d2a30d10d3', '玩家帐号', '/helper.mj/mjPlayerAccount', 'helper/mj/MjPlayerAccountList', null, null, '1', null, '1', '12', '0', null, '1', '1', '0', '0', null, 'admin', '2019-09-07 08:59:59', null, null, '0', '0', '1');
INSERT INTO `sys_permission` VALUES ('2153552be661d70b0bf4b2926b2c11cc', '13a0e4c46a99956339f0e4d2a30d10d3', '支付图片', '/helper.mj/mjPayPicture', 'helper/mj/MjPayPictureList', null, null, '1', null, '1', '6', '0', null, '1', '1', '0', '0', null, 'admin', '2019-09-06 22:14:11', null, null, '0', '0', '1');
...
INSERT INTO `sys_permission` VALUES ('3afba0aff560a9256800ecfc70b55fa4', '13a0e4c46a99956339f0e4d2a30d10d3', '收款银行卡', '/helper.mj/mjCar', 'helper/mj/MjCardList', null, null, '1', null, '1', '4', '0', null, '1', '1', '0', '0', null, 'admin', '2019-09-06 22:11:03', null, null, '0', '0', '1');
...
INSERT INTO `sys_permission` VALUES ('4f1f7439fe7227496100505d2bc0a251', '13a0e4c46a99956339f0e4d2a30d10d3', '游戏设置', '/helper.mj/mjConf', 'helper/mj/MjConfList', null, null, '1', null, '1', '5', '0', null, '1', '1', '0', '0', null, 'admin', '2019-09-06 22:12:46', null, null, '0', '0', '1');
...
INSERT INTO `sys_permission` VALUES ('5f59bb2b804c51b4dbdc762323edc349', '13a0e4c46a99956339f0e4d2a30d10d3', '收款帐号', '/helper.mj/mjAccount', 'helper/mj/MjAccountList', null, null, '1', null, '1', '3', '0', null, '1', '1', '0', '0', null, 'admin', '2019-09-06 22:09:42', null, null, '0', '0', '1');
INSERT INTO `sys_permission` VALUES ('627af884cfe50a614f89d18d8570ca6e', '13a0e4c46a99956339f0e4d2a30d10d3', '返现记录', '/helper.mj/mjCashBackRecord', 'helper/mj/MjCashBackRecordList', null, null, '1', null, '1', '9', '0', null, '1', '1', '0', '0', null, 'admin', '2019-09-06 22:17:04', 'admin', '2019-09-08 18:41:53', '0', '0', '1');
...
INSERT INTO `sys_permission` VALUES ('85cc08c8552c7febe47c455aea42f9d5', '13a0e4c46a99956339f0e4d2a30d10d3', '可返记录', '/helper.mj/mjCashBackCan', 'helper/mj/MjCashBackCanList', null, null, '1', null, '1', '8', '0', null, '1', '1', '0', '0', null, 'admin', '2019-09-06 22:16:19', 'admin', '2019-09-08 18:41:29', '0', '0', '1');
...
INSERT INTO `sys_permission` VALUES ('908a6c922f4dc45ab0c5de0cbc96dcc5', '13a0e4c46a99956339f0e4d2a30d10d3', '通知消息', '/helper.mj/mjNotice', 'helper/mj/MjNoticeList', null, null, '1', null, '1', '10', '0', null, '1', '1', '0', '0', null, 'admin', '2019-09-06 22:17:54', null, null, '0', '0', '1');
INSERT INTO `sys_permission` VALUES ('910541c89808e8fc2bff578b8d915ac4', '13a0e4c46a99956339f0e4d2a30d10d3', '游戏平台', '/helper.mj/mjGame', 'helper/mj/MjGameList', null, null, '1', null, '1', '1', '0', null, '1', '1', '0', '0', null, 'admin', '2019-09-06 22:05:14', null, null, '0', '0', '1');
...
INSERT INTO `sys_permission` VALUES ('bad946175393c49d0f5c5b8c63d21550', '', '广告管理', '/ad', 'layouts/RouteView', null, null, '0', null, '1', '1', '0', 'sound', '1', '0', '0', '0', null, 'admin', '2019-09-06 21:52:32', 'admin', '2019-09-06 21:54:15', '0', '0', '1');
...
INSERT INTO `sys_permission` VALUES ('d7e35c7194561960b8ba1880585bb3a3', '13a0e4c46a99956339f0e4d2a30d10d3', '支付记录', '/helper.mj/mjPayRecord', 'helper/mj/MjPayRecordList', null, null, '1', null, '1', '7', '0', null, '1', '1', '0', '0', null, 'admin', '2019-09-06 22:15:15', null, null, '0', '0', '1');
...
INSERT INTO `sys_permission` VALUES ('e8b56a060122e3c05cbf89a858ca5493', '13a0e4c46a99956339f0e4d2a30d10d3', '可用游戏', '/helper.mj/mjPlayerGame', 'helper/mj/MjPlayerGameList', null, null, '1', null, '1', '13', '0', null, '1', '1', '0', '0', null, 'admin', '2019-09-07 09:00:49', 'admin', '2019-09-07 09:01:36', '0', '0', '1');
...
INSERT INTO `sys_permission` VALUES ('ec3020e06823bc26bd318055c120c732', 'bad946175393c49d0f5c5b8c63d21550', '广告列表', '/ad/ad', 'ad/AdList', null, null, '1', null, '1', '1', '0', null, '1', '1', '0', '0', null, 'admin', '2019-09-06 21:55:33', 'admin', '2019-09-06 21:56:23', '0', '0', '1');
...
INSERT INTO `sys_permission` VALUES ('eca530f7f6c6743a3d8e29c49f51499a', '13a0e4c46a99956339f0e4d2a30d10d3', '玩家银行卡', '/helper.mj/mjPlayerCard', 'helper/mj/MjPlayerCardList', null, null, '1', null, '1', '11', '0', null, '1', '1', '0', '0', null, 'admin', '2019-09-07 08:56:12', null, null, '0', '0', '1');
...
INSERT INTO `sys_permission` VALUES ('fb268db77f22de7fae09fe327ebaf6ea', 'e41b69c57a941a3bbcce45032fe57605', 'Online图表配置', '/online/graphreport', 'modules/online/graphreport/OnlGraphreportHeadList', null, null, '1', null, '1', '2', '0', null, '1', '1', '0', '0', null, 'admin', '2019-09-02 11:05:01', null, null, '0', '0', '1');
...
INSERT INTO `sys_role_permission` VALUES ('15717de294724cded966a53fba231e0c', 'f6817f48af4fb3af11b9e8bf182f618b', 'e8b56a060122e3c05cbf89a858ca5493', null);
...
INSERT INTO `sys_role_permission` VALUES ('19c8d0e8aa7d91fc56da4c88fe2a4f7f', 'f6817f48af4fb3af11b9e8bf182f618b', '85cc08c8552c7febe47c455aea42f9d5', null);
...
INSERT INTO `sys_role_permission` VALUES ('2e4336283c4c8b1f7b95073068502ebf', 'f6817f48af4fb3af11b9e8bf182f618b', '910541c89808e8fc2bff578b8d915ac4', null);
...
INSERT INTO `sys_role_permission` VALUES ('3fd89430d7c00d0092e56bd52b5276bc', 'f6817f48af4fb3af11b9e8bf182f618b', '2153552be661d70b0bf4b2926b2c11cc', null);
INSERT INTO `sys_role_permission` VALUES ('404c29391426504f7c53c2010a054728', 'f6817f48af4fb3af11b9e8bf182f618b', '3afba0aff560a9256800ecfc70b55fa4', null);
INSERT INTO `sys_role_permission` VALUES ('408e40c0bb5cac1d014f320a7788948f', 'f6817f48af4fb3af11b9e8bf182f618b', 'eca530f7f6c6743a3d8e29c49f51499a', null);
...
INSERT INTO `sys_role_permission` VALUES ('48eb83d1ccc9accaa7784926a42505f4', 'f6817f48af4fb3af11b9e8bf182f618b', '908a6c922f4dc45ab0c5de0cbc96dcc5', null);
...
INSERT INTO `sys_role_permission` VALUES ('5efb74a3fd6b82e80bb396845009e87a', 'f6817f48af4fb3af11b9e8bf182f618b', '20407579ea9e2ab7b7c076dc07f4db57', null);
...
INSERT INTO `sys_role_permission` VALUES ('6e931ba3a6a43c1c67d0abd5ace29389', 'f6817f48af4fb3af11b9e8bf182f618b', '5f59bb2b804c51b4dbdc762323edc349', null);
...
INSERT INTO `sys_role_permission` VALUES ('72e1b544e72528bfd0f9d4c7f542f4ed', 'f6817f48af4fb3af11b9e8bf182f618b', '4f1f7439fe7227496100505d2bc0a251', null);
...
INSERT INTO `sys_role_permission` VALUES ('b89d5a9c3d5a621fa8cb6b64b66d1cc1', 'f6817f48af4fb3af11b9e8bf182f618b', 'bad946175393c49d0f5c5b8c63d21550', null);
...
INSERT INTO `sys_role_permission` VALUES ('bd639dcd0ac29d42a1d8e5478141078b', 'f6817f48af4fb3af11b9e8bf182f618b', 'd7e35c7194561960b8ba1880585bb3a3', null);
...
INSERT INTO `sys_role_permission` VALUES ('c6f92d83117ccd82e58eb7412186d356', 'f6817f48af4fb3af11b9e8bf182f618b', '04b6b9218c0ca9f008b21b5cebdbe4cb', null);
...
INSERT INTO `sys_role_permission` VALUES ('d81b2bac64ad3848e1a4bc8a9a3410cf', 'f6817f48af4fb3af11b9e8bf182f618b', '13a0e4c46a99956339f0e4d2a30d10d3', null);
...
INSERT INTO `sys_role_permission` VALUES ('effd5f9b92857d1d49b88d95ebe0f7cf', 'f6817f48af4fb3af11b9e8bf182f618b', 'fb268db77f22de7fae09fe327ebaf6ea', null);
...
INSERT INTO `sys_role_permission` VALUES ('f19953db83fcd33bb9c69f5406b6aa97', 'f6817f48af4fb3af11b9e8bf182f618b', 'ec3020e06823bc26bd318055c120c732', null);
INSERT INTO `sys_role_permission` VALUES ('f85085238d8b563cd32f6523124ec22a', 'f6817f48af4fb3af11b9e8bf182f618b', '627af884cfe50a614f89d18d8570ca6e', null);
